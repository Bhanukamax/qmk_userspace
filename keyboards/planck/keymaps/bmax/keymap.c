...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [_DVORAK] = LAYOUT_planck_grid_wrapper( // Dvorak
		...
		XXXXXXX, XXXXXXX, XXXXXXX, __DVORAK_MOD_L__, XXXXXXX, XXXXXXX, __DVORAK_MOD_R__, KC_LEFT, XXXXXXX, KC_RIGHT
        ),
     [_APTMAK] = LAYOUT_planck_grid_wrapper( // Dvorak
		 ____APTMAK_L1____, XXXXXXX, XXXXXXX, ____APTMAK_R1____,
		 ____APTMAK_L2____, XXXXXXX, XXXXXXX, ____APTMAK_R2____,
		 ____APTMAK_L3____, XXXXXXX, XXXXXXX, ____APTMAK_R3____,
		 XXXXXXX, XXXXXXX, XXXXXXX,		 __APTMAK_MOD_L__,  XXXXXXX, XXXXXXX,  __APTMAK_MOD_R__, XXXXXXX, XXXXXXX, XXXXXXX
    ),
    [_SYS] = LAYOUT_planck_grid_wrapper(
		____EMPTY______, XXXXXXX, XXXXXXX, ____SYS_R1_____,
		____SYS_L2_____, XXXXXXX, XXXXXXX, ____SYS_R2_____,
		____SYS_L3_____, XXXXXXX, XXXXXXX, ____SYS_R3_____,
		XXXXXXX, XXXXXXX, XXXXXXX,		KC_ESC, _______, XXXXXXX, XXXXXXX, _______, _______,  XXXXXXX, XXXXXXX, XXXXXXX),
    [_SYM1] = LAYOUT_planck_grid_wrapper(
		____EMPTY______,  XXXXXXX, XXXXXXX, ____EMPTY______,
		____SYM1_L2_____, XXXXXXX, XXXXXXX, ____SYM1_R2_____,
		____SYM1_L3_____, XXXXXXX, XXXXXXX, ____SYM1_R3_____,
		XXXXXXX, XXXXXXX, XXXXXXX,		KC_ESC, _______,  XXXXXXX, XXXXXXX, _______, _______, XXXXXXX, XXXXXXX, XXXXXXX),
    [_SYM0] = LAYOUT_planck_grid_wrapper(
		____SYM_L1____,  XXXXXXX, XXXXXXX, ____SYM_R1____,
		____SYM_L2____,  XXXXXXX, XXXXXXX, ____SYM_R2____,
		____SYM_L3____,  XXXXXXX, XXXXXXX, ____SYM_R3____,
		XXXXXXX, XXXXXXX, XXXXXXX,		KC_ESC, _______, XXXXXXX, XXXXXXX, _______, _______, XXXXXXX, XXXXXXX, XXXXXXX
          ),
    [_NUMBER] = LAYOUT_planck_grid_wrapper(
		____NOMBER_L1_____,   XXXXXXX, XXXXXXX,  ____NOMBER_R1_____,
		____NOMBER_L2_____,   XXXXXXX, XXXXXXX,  ____NOMBER_R2_____,
		____NOMBER_L3_____,   XXXXXXX, XXXXXXX,  ____NOMBER_R3_____,
		XXXXXXX, XXXXXXX, XXXXXXX,        KC_TRNS, KC_TRNS, XXXXXXX, XXXXXXX, KC_BSPC, MO(_FN), XXXXXXX, XXXXXXX, XXXXXXX),
    ...
    [_MUS] = LAYOUT_planck_grid_wrapper( // Nav layer
        ...
        ____MUS_L2____,   XXXXXXX, XXXXXXX, ____MUS_R2____,
        ____MUS_L3____,   XXXXXXX, XXXXXXX, ____MUS_R3____,
		XXXXXXX, XXXXXXX, XXXXXXX, KC_TRNS, KC_TRNS, XXXXXXX, XXXXXXX, KC_BSPC, MO(_FN),XXXXXXX, XXXXXXX, XXXXXXX)
};
