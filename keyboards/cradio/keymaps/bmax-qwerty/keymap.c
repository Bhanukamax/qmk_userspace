...
#define __DVORAK_MOD_L__  KC_RALT, LT(_SYM0, KC_SPC)
...
#define ____DVORAK_R1_MOD KC_Y, KC_U, KC_I, KC_O, KC_P
#define ____DVORAK_R3_MOD KC_N, BRLR(KC_M, KC_QUOT, KC_COMM), KC_SLASH
